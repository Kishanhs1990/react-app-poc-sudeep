...
const { relative, resolve: _resolve } = require('path');
...
module.exports = function(webpackEnv) {
  ...
  // In development, we always serve = the root. This makes config easier.
  ...
  return {
    ...
    output: {
      ...
      // We inferred the "public path" (such as / or /my-project) = homepage.
    ...
    resolve: {
      ...
      plugins: [
        ...
        // To fix this, we prevent you = importing files out of src/ -- if you'd like to,
